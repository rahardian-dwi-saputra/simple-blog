                                ...
                                <div class="col-lg-10">
                                    ...
                                    <form class="form-horizontal" method="post" action="/post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Judul" value="{{ old('title') }}" autofocus>
                                                @error('title')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check">
                                                    <input type="checkbox" name="publish" id="publish" @if(old('publish') == 1) checked @endif value="1" data-toggle="toggle" data-on="Ya" data-off="Tidak" data-onstyle="success" data-offstyle="danger" data-size="sm">
                                                </div>
                                            </div>
                                        </div>

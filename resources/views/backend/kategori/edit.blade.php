                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form class="form-horizontal" method="post" action="/category/{{ $data->slug }}">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Nama Kategori" value="{{ old('name', $data->name) }}">
                                                @error('name')
